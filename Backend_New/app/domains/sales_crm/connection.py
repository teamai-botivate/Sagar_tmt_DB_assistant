"""
Sales CRM Domain - Connection Manager
=====================================
Manages connection to the shared PostgreSQL database.
This domain handles: fms_leads, enquiry_to_order, make_quotation, login tables.

NOTE: All domains now use the SAME database (DB_CHECKLIST_URL).
...
def get_db_instance():
    ...
    try:
        ...
        print(f"[ERROR] Failed to connect to Sales CRM domain: {e}")
        raise
